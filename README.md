...
output_directory = 'path/to/output_directory'   # if output path string is empty string or None and not provided, it defaults to use the current working directory 
